  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 border-2 lg:px-64 gap-5 px-3">
          <div className="border-2 bg-[#F9F8F8]">
            <div className="bg-blue-teal px-3 py-2 w-fit text-white ml-[30px] mt-[29px] rounded-lg">
              Vegetable
            </div>
            <img src={brokoli} className="w-full h-[324px]" />

            <div className="w-[90%] mx-auto">
              <p className="text-[20px] text-blue-teal font-semibold">
                Calabrese Broccoli
              </p>
              ...
              <div className="flex justify-between">
                <div>
                  ...
                  <span className="text-blue-teal text-lg font-bold">
                    $11.00
                  </span>
                </div>
                <div>
