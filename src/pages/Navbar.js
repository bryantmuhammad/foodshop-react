...
const Navbar = () => {
  return (
    <div className="w-[1595px] mx-auto px-5 lg:px-0 lg:my-[69px] flex">
      <div className="flex items-center w-full gap-[150px]">
        <div className="text-blue-teal text-[38px] font-extrabold">
          Organick
        </div>
        <div className="hidden lg:block text-blue-teal text-xl font-bold">
      ...
      <div className="hidden lg:flex justify-end gap-[18px] items-center w-full ">
