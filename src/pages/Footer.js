...
import bgfooter from "../image/bgfooter.jpg";
import Button from "../components/Button";

const Footer = () => {
  return (
    <Fragment>
      <div className="w-[80%] mx-auto mt-40 px-3 xl:px-0">
        <div
          style={{ backgroundImage: `url(${bgfooter}` }}
          className="w-full space-y-10 xl:space-y-0 xl:flex xl:justify-between py-20 px-14 rounded-[30px] bg-no-repeat bg-cover"
        >
          <div className="text-white font-roboto text-5xl font-extrabold w-full xl:max-w-xs">
            Subscribe to our newsletter
          </div>
          <div className="xl:flex gap-3">
            <input className="bg-white w-full mb-5 xl:mb-0 xl:w-96 py-7 px-6 rounded-3xl border-white outline-none" />
            <Button variant="blue">Subscribe</Button>
          </div>
        </div>
      </div>
      <div className="w-[70%] mx-auto mt-40 px-3 xl:px-0 mb-14">
        <div className="space-y-10 xl:space-y-0 xl:flex xl:justify-between">
          <div className="text-center xl:text-right px-10">
            <div className="text-blue-teal font-roboto font-bold text-3xl mb-[32px]">
              Contact Us
            </div>
            <ul className="font-open-sans text-silver-teal text-lg space-y-6">
              <li>
          ...
          <div className="text-center border-r-2 border-l-2">
            <div className="font-roboto text-blue-teal text-4xl font-bold mb-[23px]">
              Organick
            </div>
            <div className="text-silver-teal font-open-sans text-lg w-[60%] mx-auto">
              Simply dummy text of the printing and typesetting industry. Lorem
              Ipsum simply dummy text of the printing
            </div>
            <div className="w-fit mx-auto flex mt-[49px] gap-4">
              <svg
          ...
          <div className="text-center xl:text-left px-10">
            <div className="text-blue-teal font-roboto font-bold text-3xl mb-[32px]">
              Utility Page
            </div>
            <ul className="font-open-sans text-silver-teal text-lg space-y-6">
